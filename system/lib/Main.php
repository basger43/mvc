...
4 	$this->abc[1]() evabe method call korle error show korbe. shutoran method er name take ekta variable e nie 		{} shoho call kora lagbe : $var = $this->methodName->abc[1]; $this->controller->{$this->methodName}();
